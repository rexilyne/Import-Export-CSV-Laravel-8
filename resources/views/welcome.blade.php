...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="container my-5">
            ...
            <div class="row">
                ...
                @if (session('success'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        {{ session('success') }}
                        {{-- Dismiss yang punya class = alert --}}
                ...
                <table>
                    <thead>
                        <tr>
                            {{-- Scope = "col", header adalah column --}}
                            <th scope="col">#</th>
            ...
            {{-- Modal --}}
            {{-- Tabindex untuk jika pencet keyboard tab apakah focusable atau tidak, -1 artinya tidak focusable --}}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {{-- enctype="multipart/form-data" wajib jika ingin upload file pada form --}}
